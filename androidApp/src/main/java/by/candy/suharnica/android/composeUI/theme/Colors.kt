...
val baseLightPalette = CandyColors(
...
val baseDarkPalette = CandyColors(
...
val redSaleBgLightPalette = baseLightPalette.copy(
    tintColor = Color(0x80FF5F3C)
)

val redSaleBgDarkPalette = baseLightPalette.copy(
    tintColor = Color(0x80FF5F3C)
)
